...
const twitterClient = TW_ENABLE && new Twitter(TW_API_KEY, TW_API_KEY_SECRET, TW_ACCESS_TOKEN, TW_ACCESS_TOKEN_SECRET, BUFFER_ACCESS_TOKEN, BUFFER_TWITTER_PROFILE_ID)
